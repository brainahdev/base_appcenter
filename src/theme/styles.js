...
export default {
  ...
  navbarButton: {
    tintColor: Colors.brand.black,
  },
  navbarStyle:{backgroundColor:Colors.brand.navbar,top:0,padding:0,margin:0,borderBottomWidth:0},
  ...
  lightFontText2:{
    fontFamily: 'OpenSans-Light',fontWeight:'400',textAlign:'left'
  },
  lightFontText1:{
    fontFamily: 'OpenSans-Light',fontWeight:'100',textAlign:'left'
  },
  lightFontText:{
    fontFamily: 'OpenSans-Light',fontWeight:'normal',textAlign:'left'
  },
  regularFontText:{
    fontFamily: 'OpenSans',fontWeight:'normal',textAlign:'left'
  },
  semiBoldedFontText:{
    fontFamily: 'OpenSans-Semibold',textAlign:'left'
  },
  boldedFontText:{
