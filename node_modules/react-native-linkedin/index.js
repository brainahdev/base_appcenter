...
export default class LinkedInModal extends React.Component {
  ...
  renderButton = () => {
    ...
    return <Text style={{color:'#fff',fontFamily:'OpenSans'}}>{linkText}</Text>
  }
  ...
  render() {
    ...
    return (
      <View>
        <TouchableOpacity style={{margin:10,backgroundColor:'#0077B5',borderRadius:50,height:50,justifyContent:'center',alignItems:'center',flexDirection:'row'}} onPress={this.open}>
			<Image source={require('./assets/326115-32.png')} style={{width:22,height:22,marginRight:15}} />
			{this.renderButton()}
		</TouchableOpacity>
        <Modal
