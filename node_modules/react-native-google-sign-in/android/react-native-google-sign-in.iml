...
<module external.linked.project.id=":react-native-google-sign-in" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" external.system.module.group="StarterKit" external.system.module.version="unspecified" type="JAVA_MODULE" version="4">
  <component name="FacetManager">
    <facet type="android-gradle" name="Android-Gradle">
      <configuration>
        <option name="GRADLE_PROJECT_PATH" value=":react-native-google-sign-in" />
      </configuration>
    </facet>
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7" inherit-compiler-output="false">
    ...
    <orderEntry type="library" exported="" name="play-services-auth-api-phone-license-11.8.0" level="project" />
    <orderEntry type="library" exported="" name="play-services-auth-api-phone-11.8.0" level="project" />
    ...
    <orderEntry type="library" exported="" name="play-services-auth-11.8.0" level="project" />
    ...
    <orderEntry type="library" exported="" name="play-services-auth-base-license-11.8.0" level="project" />
    <orderEntry type="library" exported="" name="react-native-0.44.3" level="project" />
    <orderEntry type="library" exported="" name="play-services-auth-base-11.8.0" level="project" />
